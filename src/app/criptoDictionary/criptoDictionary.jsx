  ...
  return (
    <div className="text-gray-400 m-20">
      <div className="text-center">
        <h1 className="md:text-2xl lg:text-2xl text-xl text-gray-300">
          Crypto Dictionary
        </h1>
      ...
      <div className="relative cursor-pointer mt-10">
        <img
          className="w-[99vw] h-[10rem] md:w-auto md:h-auto"
        ...
        <div className="absolute bottom-0 left-0 flex justify-between w-full items-center p-5">
          <div>
            <h1 className="md:text-2xl text-sm font-bold text-gray-200">
              Web3 + Degen Glossary
            </h1>
